...
public class EntityFactory {
	...
	public void produceClass(String tableName,String path,String className) {
		...
		if (boo) {
			writeFile();
			System.out.println("�Ѿ����" + getClassName(sentence) + ".java"
					+ "\t·��" + outpath);
		} else {
	...
	public static  String getColunmComments(String tableName) {
		...
		try {
			PropertiesUtil pUtil = new PropertiesUtil("jdbc.properties");
	...
	public static String getPackagePath(String path){
		...
		return sb.toString().substring(14);
	}
	
	public static void main(String[] args) {
		
		EntityFactory entityFactory=new EntityFactory();
		entityFactory.produceClass("user","src\\main\\java\\cn\\lxj\\Entity\\", "User");
	}
}
